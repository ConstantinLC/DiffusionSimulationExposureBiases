        ...
        for batch_idx, sample in enumerate(traj_loader):
            ...
            for t in range(1, rollout_steps+1):
                for name, model in models.items():
                    ...
                    current_inputs[name] = current_preds[name]
                    # 2. Step forward
...
def main():
    ...
    parser.add_argument('--config', type=str, required=True, help="Directory to save plots and metrics")
    ...
    gt_trajectory = results["data"][:, 1:args.rollout_steps] 
